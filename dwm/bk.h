...
static const char *fonts[]          = { "Traveling _Typewriter:size=12:style=Regular", "Symbols Nerd Font:size=12" };
static const char dmenufont[]       = "Traveling _Typewriter:size=12:style=Regular";
