 ...
 */
static char *font = "FiraCode Nerd Font Mono Light:style=Light:size=11";
static char *font2[] = {"FiraCode Nerd Font Mono Light:style=Light:size=11"};
 ...
 */
static const char *bgfile = "/Downloads/nymphs.jpg";
